...
/**
 * @name                - Get public
 * @description         - Retrieves user data that is public (some attributes may be hidden)
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Get private
 * @description         - Retrieves private user data
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
 ...
 * @description         - Retrieves user paginated data (public data - Attributes may be hidden)
 * @param query         - Query
...
/**
 * @name                - Update
 * @description         - Finds one user that matches query and updates
 * @param query         - Query
...
/**
 * @name                - Update many
 * @description         - Finds all user data that matches query and update
 * @param query         - Query
 * @param updateData    - Update data
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove
 * @description         - Finds user and removes.
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove many
 * @description         - Removes all user document that matches query
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
