...
/**
 * @name                - Get public
 * @description         - Retrieves schema data that is public (some attributes may be hidden)
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Get private
 * @description         - Retrieves private schema data
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
 ...
 * @description         - Retrieves schema paginated data (public data - Attributes may be hidden)
 * @param query         - Query
...
/**
 * @name                - Update
 * @description         - Finds one schema that matches query and updates
 * @param query         - Query
...
/**
 * @name                - Update many
 * @description         - Finds all schema data that matches query and update
 * @param query         - Query
 * @param updateData    - Update data
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove
 * @description         - Finds schema and removes.
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
...
/**
 * @name                - Remove many
 * @description         - Removes all schema document that matches query
 * @param query         - Query
 * @param callback      - Callback function (error,data)
 */
